...
#define ABOVE_LIGHTING_PLANE_ADDITIVE	(18)

	#define MAPPING_AREA_LAYER			999	// Why isn't this a plane exactly?

#define FAKE_CAMERA_SCREEN_PLANE 19

#define OPEN_OVERLAY_PLANE	(20 + FLOAT_PLANE) // This one won't behave either

#define BASE_PLANE 				(21 + FLOAT_PLANE)		//  this is where darkness is! see "how planes work" - needs SEE_BLACKNESS or SEE_PIXEL (see blackness is better for ss13)

#define NARSIE_PLANE			22

#define ANTAG_HUD_PLANE		 	23

#define STATIC_PLANE 			24		// For AI's static.

	#define HACK_LAYER 					1
	#define STATIC_LAYER				2
	#define REACTIVATE_CAMERA_LAYER		3

#define FULLSCREEN_PLANE		25		// for fullscreen overlays that do not cover the hud.
...
#define HUD_PLANE 				26		// For the Head-Up Display
...
#define ABOVE_HUD_PLANE 		27		// For being above the Head-Up Display
