...
#define MILLA_INDEX_CARBON					3
#define MILLA_INDEX_NITROGEN				4
#define MILLA_INDEX_PLASMA					5
#define MILLA_INDEX_SLEEPING				6
#define MILLA_INDEX_CRYOTHEUM				7
#define MILLA_INDEX_VOLATILE_FUEL			8
#define MILLA_INDEX_OXAGENT					9
