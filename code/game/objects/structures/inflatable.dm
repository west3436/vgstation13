...
/obj/structure/inflatable/shelter/forceMove(var/atom/NewLoc, Dir = 0, step_x = 0, step_y = 0, var/glide_size_override = 0) //Like an unanchored window, we can block if pushed into place.
	..()
	update_nearby_tiles()
