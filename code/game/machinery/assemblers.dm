/obj/machinery/autoprocessor/assembler
	name = "Assembler"
...
/obj/machinery/autoprocessor/assembler/New()
	. = ..()

	component_parts = newlist(
		/obj/item/weapon/circuitboard/autoprocessor/assembler,
...
/obj/machinery/autoprocessor/assembler/attackby(var/obj/item/I, mob/user)
...
/obj/machinery/autoprocessor/assembler/attack_hand(mob/user)
	if(active_tool)
		to_chat(user, "<span class='notice'>You remove \the [active_tool] from \the [src]'s tool chamber.</span>")
		user.put_in_hands(active_tool)
		active_tool = null

// /obj/machinery/autoprocessor/assembler/Crossed(atom/movable/A)
// 	icon_state = "active"
// 	if(fueled)
// 		if(!check_fuel)
// 			error_buzz()
...
// /obj/machinery/autoprocessor/assembler/Uncrossed(atom/movable/A)
// 	icon_state = "inactive"

/obj/machinery/autoprocessor/assembler/proc/check_fuel(var/material)
...
/obj/machinery/autoprocessor/assembler/emag_act(var/mob/user, var/obj/item/weapon/card/emag/E)
	if(!src.emagged)
		spark(src, 1)
		src.emagged = 1
		if(user)
