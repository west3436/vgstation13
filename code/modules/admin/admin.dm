...
/datum/admins/proc/procedural_generation_panel()
	...
	if(SSmapping.planets.len)
		...
		dat += "<tr><th>Planet Name</th><th>Planet Type</th><th>Heat</th><th>Humidity</th><th>Terrain</th><th>Atmosphere</th><th>Weather</th><th>Time</th><th>Landing Zone</th><th>Visibility</th><th>Actions</th></tr>"
