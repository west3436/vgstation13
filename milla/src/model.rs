...
impl GasSet {
    ...
    pub(crate) fn carbon_dioxide(&self) -> f32 {
        self.values[GAS_CARBON]
    }
    pub(crate) fn set_carbon_dioxide(&mut self, value: f32) {
        self.values[GAS_CARBON] = value;
        self.dirty.store(true, Relaxed);
    }
    ...
    pub(crate) fn plasma(&self) -> f32 {
        self.values[GAS_PLASMA]
    }
    pub(crate) fn set_plasma(&mut self, value: f32) {
        self.values[GAS_PLASMA] = value;
        self.dirty.store(true, Relaxed);
    }
    pub(crate) fn sleeping_agent(&self) -> f32 {
        self.values[GAS_SLEEPING]
    }
    pub(crate) fn set_sleeping_agent(&mut self, value: f32) {
        self.values[GAS_SLEEPING] = value;
        self.dirty.store(true, Relaxed);
    }
    pub(crate) fn cryotheum(&self) -> f32 {
        self.values[GAS_CRYOTHEUM]
    }
    pub(crate) fn set_cryotheum(&mut self, value: f32) {
        self.values[GAS_CRYOTHEUM] = value;
        self.dirty.store(true, Relaxed);
    }
    pub(crate) fn volatile_fuel(&self) -> f32 {
        self.values[GAS_VOLATILE]
    }
    pub(crate) fn set_volatile_fuel(&mut self, value: f32) {
        self.values[GAS_VOLATILE] = value;
        self.dirty.store(true, Relaxed);
    }
    pub(crate) fn oxygen_agent_b(&self) -> f32 {
        self.values[GAS_OXAGENT]
    }
    pub(crate) fn set_oxygen_agent_b(&mut self, value: f32) {
        self.values[GAS_OXAGENT] = value;
        self.dirty.store(true, Relaxed);
    }
...
impl From<&Tile> for Vec<ByondValue> {
    fn from(value: &Tile) -> Self {
        ...
        vec![
            ...
            ByondValue::from(value.gases.plasma()),
            ByondValue::from(value.gases.sleeping_agent()),
            ByondValue::from(value.gases.cryotheum()),
            ByondValue::from(value.gases.volatile_fuel()),
            ByondValue::from(value.gases.oxygen_agent_b()),
