...
fn create_environment(
    ...
    cryotheum: ByondValue,
    volatile_fuel: ByondValue,
    oxygen_agent_b: ByondValue,
    ...
    Ok(ByondValue::from(internal_create_environment(
        ...
        conversion::byond_to_option_f32(plasma)?,
        conversion::byond_to_option_f32(sleeping_agent)?,
        conversion::byond_to_option_f32(cryotheum)?,
        conversion::byond_to_option_f32(volatile_fuel)?,
        conversion::byond_to_option_f32(oxygen_agent_b)?,
...
pub(crate) fn internal_create_environment(
    ...
    cryotheum: Option<f32>,
    volatile_fuel: Option<f32>,
    oxygen_agent_b: Option<f32>,
    ...
    if let Some(value) = plasma {
        tile.gases.set_plasma(value);
    }
    if let Some(value) = sleeping_agent {
        tile.gases.set_sleeping_agent(value);
    }
    if let Some(value) = cryotheum {
        tile.gases.set_cryotheum(value);
    }
    if let Some(value) = volatile_fuel {
        tile.gases.set_volatile_fuel(value);
    }
    if let Some(value) = oxygen_agent_b {
        tile.gases.set_oxygen_agent_b(value);
    }
...
fn set_tile(
    ...
    internal_set_tile(
        ...
        conversion::bounded_byond_to_option_f32(plasma, 0.0, f32::INFINITY)?,
        conversion::bounded_byond_to_option_f32(sleeping_agent, 0.0, f32::INFINITY)?,
        conversion::bounded_byond_to_option_f32(cryotheum, 0.0, f32::INFINITY)?,
        conversion::bounded_byond_to_option_f32(volatile_fuel, 0.0, f32::INFINITY)?,
        conversion::bounded_byond_to_option_f32(oxygen_agent_b, 0.0, f32::INFINITY)?,
