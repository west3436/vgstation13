...
pub(crate) const MAP_SIZE: usize = 500;
...
/// How many moles are needed to make plasma visible.
pub(crate) const PLASMA_VISIBILITY_MOLES: f32 = 0.5;
...
pub(crate) const GAS_CARBON: usize = 1;

/// Index for nitrogen in gas list.
pub(crate) const GAS_NITROGEN: usize = 2;

/// Index for plasma in gas list.
pub(crate) const GAS_PLASMA: usize = 3;

/// Index for sleeping agent in gas list.
pub(crate) const GAS_SLEEPING: usize = 4;

/// Index for cryotheum in gas list.
pub(crate) const GAS_CRYOTHEUM: usize = 5;

/// Index for volatile fuel in gas list.
pub(crate) const GAS_VOLATILE: usize = 6;

/// Index for agent b in gas list.
pub(crate) const GAS_OXAGENT: usize = 7;

/// How many gases are there?
pub(crate) const GAS_COUNT: usize = GAS_OXAGENT + 1;
...
pub(crate) const SPECIFIC_HEAT_CARBON: f32 = 30.0;

// The specific heat of nitrogen, in joules per kelvin-mole.
pub(crate) const SPECIFIC_HEAT_NITROGEN: f32 = 20.0;

// The specific heat of plasma, in joules per kelvin-mole.
pub(crate) const SPECIFIC_HEAT_PLASMA: f32 = 200.0;

// The specific heat of sleeping agent, in joules per kelvin-mole.
pub(crate) const SPECIFIC_HEAT_SLEEPING: f32 = 40.0;

// The specific heat of plasma, in joules per kelvin-mole.
pub(crate) const SPECIFIC_HEAT_CRYOTHEUM: f32 = 10.0;

// The specific heat of sleeping agent, in joules per kelvin-mole.
pub(crate) const SPECIFIC_HEAT_VOLATILE: f32 = 30.0;

// The specific heat of agent b, in joules per kelvin-mole.
pub(crate) const SPECIFIC_HEAT_OXAGENT: f32 = 300.0;
...
pub(crate) const SPECIFIC_HEATS: [f32; GAS_COUNT] = [
    ...
    SPECIFIC_HEAT_CARBON,
    SPECIFIC_HEAT_NITROGEN,
    SPECIFIC_HEAT_PLASMA,
    SPECIFIC_HEAT_SLEEPING,
	SPECIFIC_HEAT_CRYOTHEUM,
	SPECIFIC_HEAT_VOLATILE,
    SPECIFIC_HEAT_OXAGENT,
];
...
/// How much thermal energy is produced, in joules per mole of sleeping plasma.
